...
class CameraProcessor5 extends CameraProcessor{
	...
	public void processImage(Mat imageToProcess) {
		...
		for(int index=0;index<contours.size();index++){
			...
			if (area>maxArea && area>1000 && rect.width>50){
				boundingRect=rect;
				reactorSpotted = true;
				maxArea = area;
			}	
		...
		//System.out.println("left distance interface wall: " + leftDistance);
		//System.out.println("right distance interface wall: " + rightDistance);
		...
		//System.out.println("angle to turn parallel interface wall: " + angleToTurnParallelDegrees);
		...
		//System.out.println("asdfasf:"+ centerXValue);
