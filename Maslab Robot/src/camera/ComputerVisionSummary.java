...
public class ComputerVisionSummary {
    ...
    private final static double MAX_WALL_DISTANCE_MIDDLE = 6;
    private final static double MAX_WALL_DISTANCE_LEFT = 7.5;
    private final static double MAX_WALL_DISTANCE_RIGHT = 7.5;
